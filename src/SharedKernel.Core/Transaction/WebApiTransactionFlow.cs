...
namespace Clean.Microservice.Serverless.SharedKernel.Core.Transaction
{
    ...
    /// </summary>
    public class WebApiTransactionFlow : TransactionFlow
    {
        private readonly IHttpContextAccessor accessor;

        /// <summary>
        /// Initializes a new instance of the <see cref="WebApiTransactionFlow"/> class.
        /// </summary>
        /// <param name="accessor">See <see cref="IHttpContextAccessor"/>.</param>
        public WebApiTransactionFlow(IHttpContextAccessor accessor)
        {
